...
### Responsibilities:
- Develop **marketing strategy** for UW Night Market 2018 campaign
- Lead **creation** and **distribution** of all promotional material (incl. graphics, posters, and videos)
- **Coordinate outreach** to UW organizations and media outlets for cross-promotions
...
- Facebook event: [facebook.com/events/991125381040343/](www.facebook.com/events/991125381040343/)

---

### Strategy:
- Track page activity of followers, schedule content release take advantage of peak page activity
- Increase post engagement by **posting more interactive content**
  - Focus on creating **eye-drawing visual content** along with **engaging copy** to attract audience
...
- These are some countdown graphics we created to post on the Facebook event page (the event mascot Bobo is featured):
...
- Here are some of our reposted photos:
